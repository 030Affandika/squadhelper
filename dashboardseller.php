        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
            ...
            <ul class="navbar-nav d-flex justify-content-end">
                ...
                <li class="nav-item me-2">
                    <a class="nav-link" style="color: #1363DF;" href="beranda.php">Beranda</a>
                </li>
                <li class="nav-item me-2">
			...
			<div class="box">
				...
				<table border="1" cellspacing="0" class="table">
					...
					<tbody>
						...
						<tr>
							<!-- <td><?php echo $no++ ?></td> -->
							<td><a href="./produk/<?php echo $row['product_image'] ?>" target="_blank"> <img src="img/<?php echo $row['product_image'] ?>" width="50px"> </a></td>
