        ...
        <div class="row" style="display: flex; flex-direction: column; align-items: center;">
            ...
            <div class="row shadow-5" style="display: flex;">
                <div class="col-md-6" style="margin: 5px; padding: 1em 1em 1em 1em;">
                    <div class="lightbox">
                        <img src="img/pilm.png" alt="Gallery image 1" class="pilm w-100"/>
                    </div>
                ...
                <div class="col-md-5" style="margin-top: 20px;">
                    <div class="card-body">
                        <h5 class="card-title" style="font-size: 38px;">Spesialis Mengerjakan Poster Film</h5>
                        <p class="card-text" style="font-size: 32px;">Rp.50.000</p><br>
                        <p class="card-text" style="font-size: 18px;">Melayani pembuatan poster film.</p><br>
